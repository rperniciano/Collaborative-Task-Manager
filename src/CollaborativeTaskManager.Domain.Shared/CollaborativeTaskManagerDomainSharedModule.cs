...
public class CollaborativeTaskManagerDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        CollaborativeTaskManagerGlobalFeatureConfigurator.Configure();
        CollaborativeTaskManagerModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<CollaborativeTaskManagerDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<CollaborativeTaskManagerResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/CollaborativeTaskManager");

            options.DefaultResourceType = typeof(CollaborativeTaskManagerResource);
        ...
        {
            options.MapCodeNamespace("CollaborativeTaskManager", typeof(CollaborativeTaskManagerResource));
        });
    }
}
