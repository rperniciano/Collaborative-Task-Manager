...
public class CollaborativeTaskManagerDbContext :
    AbpDbContext<CollaborativeTaskManagerDbContext>,
    ...
    IIdentityDbContext
{
    ...
    public CollaborativeTaskManagerDbContext(DbContextOptions<CollaborativeTaskManagerDbContext> options)
        : base(options)
    {
