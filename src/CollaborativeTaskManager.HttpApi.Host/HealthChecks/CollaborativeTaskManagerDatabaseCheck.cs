...
public class CollaborativeTaskManagerDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public CollaborativeTaskManagerDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
